...
# Clean cache
PRODUCT_COPY_FILES += \
    vendor/octavi/prebuilt/common/bin/clean_cache.sh:$(TARGET_COPY_OUT_SYSTEM)/bin/clean_cache.sh
...
PRODUCT_COPY_FILES += \
    ...
    vendor/octavi/config/permissions/privapp-permissions-octavi-system_ext.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-octavi-system_ext.xml \
