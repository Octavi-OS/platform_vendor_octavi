...
ALARM_PATH := vendor/xandar/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/xandar/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/xandar/prebuilt/common/media/audio/ringtones
