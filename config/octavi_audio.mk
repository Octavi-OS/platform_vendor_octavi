...
ALARM_PATH := vendor/octavi/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/octavi/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/octavi/prebuilt/common/media/audio/ringtones
