...
OCTAVI_BUILD_VERSION := $(OCTAVI_NUM_VER)-$(OCTAVI_BUILD_TYPE)
OCTAVI_VERSION := $(OCTAVI_BUILD_VERSION)-$(OCTAVI_BUILD)-$(BUILD_DATE)-VANILLA
ifeq ($(WITH_GAPPS), true)
OCTAVI_VERSION := $(OCTAVI_BUILD_VERSION)-$(OCTAVI_BUILD)-$(BUILD_DATE)-GAPPS
endif
